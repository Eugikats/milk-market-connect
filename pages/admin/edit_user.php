...
if ($type === 'farmer') {
    ...
    $sql = "SELECT * FROM processing_plants WHERE id = $id";
    $result = mysqli_query($conn, $sql);
    $user = mysqli_fetch_assoc($result);
    $title = "Edit Processing Plant";
} else {
...
<head>
    ...
    <title><?php echo $title; ?> - Milk Market Connect</title>
        ...
        <div class="form-container">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="processing_capacity" value="<?php echo htmlspecialchars($user['processing_capacity']); ?>" required>
                </div>
                <?php endif; ?>
